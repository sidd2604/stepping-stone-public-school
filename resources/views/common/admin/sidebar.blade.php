...
<div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
    <div class="mobile-sidebar-header d-md-none">
        <div class="header-logo">
            <a href="{{ url('/dashboard') }}"><img src="{{ asset('admintheme/images/logo1.png') }}" alt="logo"></a>
        </div>
    </div>
        ...
        <ul class="nav nav-sidebar-menu sidebar-toggle-view">
            <li class="nav-item sidebar-nav-item">
                ...
                <ul class="nav sub-group-menu">
                    <li class="nav-item">
                        <a href="{{ ('/dashboard') }}" class="nav-link"><i class="fas fa-angle-right"></i>Slider</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link"><i class="fas fa-angle-right"></i>Events</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link"><i class="fas fa-angle-right"></i>Additionals</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link"><i class="fas fa-angle-right"></i>Teachers</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link"><i class="fas fa-angle-right"></i>Blogs</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link"><i class="fas fa-angle-right"></i>Testimonials</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item sidebar-nav-item">
                <a href="#" class="nav-link"><i class="fa-solid fa-envelope"></i><span>Newsletter</span></a>
                <ul class="nav sub-group-menu sub-group-active">
                    <li class="nav-item">
                        <a href="all-student.html" class="nav-link menu-active"><i class="fas fa-angle-right"></i>Create
                            Newsletter</a>
                    </li>
                    <li class="nav-item">
                        <a href="student-details.html" class="nav-link"><i class="fas fa-angle-right"></i>All
                            Newsletters</a>
                    </li>
                    {{-- <li class="nav-item">
            ...
            <li class="nav-item sidebar-nav-item">
                <a href="#" class="nav-link"><i class="fa-solid fa-file"></i><span>Pages</span></a>
                <ul class="nav sub-group-menu">
                    <li class="nav-item">
                        <a href="all-teacher.html" class="nav-link"><i class="fas fa-angle-right"></i>Principal's Desk</a>
                    </li>
                    <li class="nav-item">
                        <a href="teacher-details.html" class="nav-link"><i class="fas fa-angle-right"></i>Founder And Trustee</a>
                    </li>
                    <li class="nav-item">
                        <a href="add-teacher.html" class="nav-link"><i class="fas fa-angle-right"></i>About Us</a>
                    </li>
                    <li class="nav-item">
                        <a href="teacher-payment.html" class="nav-link"><i class="fas fa-angle-right"></i>Rules & Regulations</a>
                    </li>
                    {{-- <li class="nav-item">
                        <a href="teacher-payment.html" class="nav-link"><i class="fas fa-angle-right"></i>Notice Board</a>
                    </li> --}}
                </ul>
            </li>
            <li class="nav-item">
